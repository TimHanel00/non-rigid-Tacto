...
def RigidObject(name="RigidObject",
    ...
    def addCollisionModel(inputMesh=surfaceMeshFileName):
        ...
        if isAStaticObject:
            ...
            objectCollis.addObject('TriangleCollisionModel', group=collisionGroup,contactStiffness=0.1)
            objectCollis.addObject('LineCollisionModel', group=collisionGroup,contactStiffness=0.1)
            objectCollis.addObject('PointCollisionModel', group=collisionGroup,contactStiffness=0.1)
