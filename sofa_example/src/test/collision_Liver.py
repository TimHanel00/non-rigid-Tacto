...
def createScene(root):
    ...
    root.addObject('RequiredPlugin',pluginName="Sofa.Component.Collision.Detection.Algorithm Sofa.Component.Collision.Detection.Intersection Sofa.Component.Mass Sofa.Component.LinearSolver.Iterative")
