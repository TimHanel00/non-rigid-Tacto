...
class TactoController(Sofa.Core.Controller):
    ...
    def getAngles(self):
        ...
        print(f"Orientation list: {orientation_list}, Type: {type(orientation_list)}")
        print(f"Elements types: {[type(i) for i in orientation_list]}")

        # 尝试将 orientation_list 转换为 Quat
